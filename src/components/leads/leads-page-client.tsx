...
import { defaultLeadPageSize, leadPageSizeOptions } from "@/components/leads/leads.constants"
    ...
    <section className="page-section">
      ...
      <Card>
        <CardHeader className="flex  gap-2 sm:flex-row sm:items-center justify-between">
          ...
          {pagination ? (
            <p className="text-sm text-muted-foreground">
              {`${pagination.totalItems} leads - Page ${pagination.page} of ${Math.max(pagination.totalPages, 1)}`}
            </p>
          ) : null}
        </CardHeader>
