...
import { LeadActionsMenu } from "@/components/crm/leads/lead-actions-menu"
import {
  leadPageSizeOptions,
      ...
      {isError ? (
        <Alert variant="destructive">
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <span>{getLeadApiMessage(error, "Unable to load CRM leads.")}</span>
        ...
        <TableRow>
          <TableCell colSpan={11} className="h-64 text-center">
            <div className="flex flex-col items-center justify-center gap-3">
              ...
              <div>
                <p className="text-sm font-medium text-foreground">No CRM leads found</p>
                <p className="text-xs text-muted-foreground mt-1">Try adjusting your filters or create a new CRM lead</p>
              </div>
            </div>
          </TableCell>
        </TableRow>
