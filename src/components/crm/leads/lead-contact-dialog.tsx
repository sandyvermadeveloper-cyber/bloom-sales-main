...
import { contactLabels } from "@/components/crm/leads/leads.constants"
...
import { leadContactSchema } from "@/schemas/lead.schemas"

export type LeadContactFormValues = z.infer<typeof leadContactSchema>

const fieldLabelClass = "text-xs font-medium text-muted-foreground"

const defaultContactValues: LeadContactFormValues = {
  firstName: "",
  lastName: "",
  designation: "",
...
type LeadContactDialogProps = {
  ...
  onSubmit: (values: LeadContactFormValues) => void
}
      ...
      <DialogContent className="max-h-[calc(100vh-2rem)] overflow-y-auto sm:max-w-2xl">
        <DialogHeader>
          ...
          <DialogDescription className="text-xs">
            Add contact details for this lead. Phone numbers must use international format.
          </DialogDescription>
        </DialogHeader>
